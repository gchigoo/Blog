...
async function installPinnedAssetRoutes(page) {
...
async function openScenario(page, scenario) {
  await installPinnedAssetRoutes(page);
  if (scenario.setupPath) {
    const setupResponse = await page.goto(scenario.setupPath, { waitUntil: 'networkidle' });
